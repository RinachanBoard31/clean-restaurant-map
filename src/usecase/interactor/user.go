...
func (ui *UserInteractor) LoginUser(userCredentals *model.UserCredentials) error {
	if err := ui.userRepository.FindBy(userCredentals); err != nil {
		return err
	}
	id := 1 // 仮のid
	if err := ui.userOutputPort.OutputLoginResult(id); err != nil {
		return err
	}
	return nil
}
